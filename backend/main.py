...
from integrations.hubspot import authorize_hubspot, get_hubspot_credentials, get_items_hubspot, oauth2callback_hubspot,transfer_hubspot_items
...
async def load_hubspot_data_integration(credentials: str = Form(...),user: str = Form(...),org: str = Form(...)):
    return await get_items_hubspot(credentials,user,org)

@app.post('/integrations/hubspot/transfer_data')
async def transfer_hubspot_data(to_org: str = Form(...),user: str = Form(...),org: str = Form(...), target_credentials:str = Form(...)):
    return await transfer_hubspot_items(to_org,user,org,target_credentials)
